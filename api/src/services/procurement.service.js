...
export class ProcurementService {
    ...
    static async getTendersByProject(project_id) {
    ...
    // ==========================
    static async createPOFromBid(bidId, createdBy) {
    ...
    static async getDeliveriesByProject(project_id) {
    ...
    static async getGoodsReceiptsByOrder(order_id) {
