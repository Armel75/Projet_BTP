...
ADD [publication_date] DATETIME2 NULL,
    ...
    [submission_mode] NVARCHAR(1000) NOT NULL CONSTRAINT [Tender_submission_mode_df] DEFAULT 'PLATFORM',
    [evaluation_method] NVARCHAR(1000) NOT NULL CONSTRAINT [Tender_evaluation_method_df] DEFAULT 'WEIGHTED',
...
CREATE TABLE [dbo].[TenderInvitation] (
    ...
    [response_status] NVARCHAR(1000) NOT NULL CONSTRAINT [TenderInvitation_response_status_df] DEFAULT 'INVITED',
